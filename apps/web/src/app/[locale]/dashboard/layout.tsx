...
const studentNav: NavItem[] = [
  ...
  { labelKey: 'lessons', href: '/learning-path', icon: '📖' },
  { labelKey: 'vocabulary', href: '/student/vocabulary', icon: '📝' },
  { labelKey: 'aiTools', href: '/ai-tools', icon: '🤖' },
  { labelKey: 'report', href: '/student/report', icon: '📈' },
